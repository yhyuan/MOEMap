...
globalConfig.searchControlHTML = '<div id="searchTheMap"></div><div id="searchHelp"></div><br>\
	...
	<fieldset>\
		<input type="radio" id="searchFacility" name="searchGroup" title="' + globalConfig.chooseLang('Search Facility / NPRI ID', "Recherche des installations / Numéro INRP") + '" value="facility" onclick="globalConfig.searchChange(\'Facility\')"></input>\
		<span class="tooltip" title="' + globalConfig.chooseLang("Search Facility: Enter facility name or NPRI ID to find facilities", "Recherche des installations : Saisir le nom de l’installation ou le numéro INRP pour trouver les installations.") + '">\
		<label class="option" for="searchFacility">' + globalConfig.chooseLang('Search Facility / NPRI ID', "Recherche des installations / Numéro INRP") + '</label>\
		</span>\
		<br/>\
...
if (globalConfig.language === "EN") {
	...
	globalConfig.tabsTemplateContent = "Installation: <b>{Facility}</b><br>Entreprise: <b>{Organisation}</b><br>Adresse: <b>{StreetAddress} / {City}</b><br>N&deg; INRP: <b>{mapConfig.displayNPRI_ID(NPRIId)}</b><br>Secteur: <b>{SectorDesc}</b><br>Toxic Substances Reported in Most Recent Year: <b>{LATESTYEARSUBSTANCENAMECOUNT}</b><br><br>[{AnnualReport}? " + globalConfig.NoAnnualReportSubmittedLang + " ?<a target='_blank' href='" + globalConfig.annualReportURL + "?id={UniqueID}'>" + globalConfig.LinktoAnnualReportsLang + "</a>]<br>[{PlanSummary}? " + globalConfig.NoPlanSummarySubmittedLang + " ?<a target='_blank' href='" + globalConfig.planSummaryURL + "?id={UniqueID}'>" + globalConfig.LinktoPlanSummariesLang + "</a>]<br>[{NUMRecord}? " + globalConfig.NoRecordSubmittedLang + " ?<a target='_blank' href='" + globalConfig.recordsURL + "?id={UniqueID}'>" + globalConfig.LinktoRecordsLang + "</a>]<br><i>" + globalConfig.OpenNewWindowLang + "</i><br>";
	globalConfig.resultsFoundLang = "installations";
	globalConfig.oneResultFoundLang = "La recherche a trouvé 1 installation";
}
...
globalConfig.otherInfoHTML = globalConfig.chooseLang("<img src='https://files.ontario.ca/moe_mapping/mapping/PGMN/greencircle.png' alt=\"green dot\" />Facilities intending to implement at least one toxic substance reduction option (as per current plan summaries)<br/><img src='https://files.ontario.ca/moe_mapping/mapping/PGMN/bluecircle.png' alt=\"blue dot\" />Facilities not intending to implement any toxic substance reduction option (as per current plan summaries) <br><strong>Note: The information and data reflected in this report is a consolidation of data reported by facilities regulated under Toxics Reduction Act, 2009 and is up to date as of 2016-09-15 . The facilities have the opportunity to notify the ministry of errors.</strong>", "<img src='https://files.ontario.ca/moe_mapping/mapping/PGMN/greencircle.png' alt='point vert' />Installations qui envisagent de mettre en œuvre au moins une option de réduction de substance toxique (selon les sommaires des plans actuels)<br/><img src='https://files.ontario.ca/moe_mapping/mapping/PGMN/bluecircle.png' alt='point bleu' />Installations qui n’envisagent pas de mettre en œuvre une option de réduction de substance toxique (selon les sommaires des plans actuels)  <br><strong>Note : l’information et les donn&eacute;es pr&eacute;sent&eacute;s dans ce rapport est une synth&egrave;se des renseignements d&eacute;clar&eacute;s par les installations et les entreprises  en vertu de la Loi de 2009 sur la r&eacute;duction des toxiques. Ces renseignements &eacute;taient &agrave; jour le 2016-09-15. Les installations et les entreprises peuvent communiquer avec le minist&egrave;re en cas d’erreurs.</strong><br><br>Certaines donn\u00e9es scientifiques et de surveillance n\u0027existent qu\u0027en anglais.");
