...
globalConfig.otherInfoHTML = globalConfig.chooseLang("<h2>Find a map error?</h2> \
	...
	<p>If you find an error in the location of a lake, river or stream, please contact us.  Use the <a href='mailto:fishguide@ontario.ca?subject=Sport Fish Map Error'>Report an error</a> link within the map pop-up.</p> \
	<h2>Comments</h2> \
	<p>For comments and suggestions, email us at <a href='mailto:fishguide@ontario.ca?subject=Sport Fish Map Feedback'>fishguide@ontario.ca</a>.</p>",'<h2>Une erreur sur la carte?</h2> \
	<p>Il est possible que des impr&eacute;cisions se soient gliss&eacute;es sur les emplacements.</p> \
	<p>Si vous trouvez une erreur d&rsquo;emplacement d&rsquo;un lac, d&rsquo;une rivi&egrave;re ou d&rsquo;un cours d&rsquo;eau, veuillez nous en avertir. Vous pouvez utiliser le lien &laquo; <a href="mailto:fishguide@ontario.ca?subject=Sport%20Fish%20Map%20Error">Signaler une erreur</a> &raquo; du menu contextuel de la carte.</p> \
	<h2>Commentaires</h2> \
	<p>Veuillez formuler vos commentaires ou vos suggestions par courriel &agrave; <a href="mailto:fishguide@ontario.ca">fishguide@ontario.ca</a>.</p>');
...
globalConfig.tabsTemplateContent = "<strong>{LOCNAME_" + globalConfig.chooseLang("EN", "FR") + "}</strong><br>{globalConfig.addBRtoLongText(GUIDELOC_" + globalConfig.chooseLang("EN", "FR") + ")}<br><br><a target='_blank' href='" + globalConfig.report_URL + "?id={WATERBODYC}'>" + globalConfig.chooseLang("Consumption Advisory Table", "Tableau des mises en garde en mati\u00e8re de<br> consommation") + "</a><br><br>Latitude <b>{globalConfig.deciToDegree(LATITUDE)}</b> Longitude <b>{globalConfig.deciToDegree(LONGITUDE)}</b><br><a href='mailto:fishguide@ontario.ca?subject=" + globalConfig.chooseLang("Portal Error", "Erreur de portail") + " (Submission {LOCNAME_" + globalConfig.chooseLang("EN", "FR") + "})'>" + globalConfig.chooseLang("Report an error for this location", "Signalez un probl\u00e8me pour ce lieu") + "</a>.<br><br>";
//globalConfig.tabsTemplateContent = "<b><font color='#799441'>{LOCNAME_" + globalConfig.language + "}</font></b><br>{globalConfig.addBRtoLongText(GUIDELOC_" + globalConfig.language + ")}<br><br><a target='_blank' href='SportFish_Report.htm?id={WATERBODYC}'>Consumption Advisory Table</a><br><br>Latitude <b>{globalConfig.deciToDegree(LATITUDE)}</b> Longitude <b>{globalConfig.deciToDegree(LONGITUDE)}</b><br><a href='mailto:fishguide@ontario.ca?subject=Portal Error (Submission {LOCNAME_" + globalConfig.language + "})'>Report an error for this location</a>.<br><br>";
