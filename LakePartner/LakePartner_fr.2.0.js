...
globalConfig.tabsTemplateContent = "<strong><font color='#799441'>{globalConfig.wordCapitalize(LAKENAME)}, STN {STN}, N&deg; du lieu {SITEID}</font></strong><br>Canton: {globalConfig.wordCapitalize(TOWNSHIP)}<br>{SITEDESC}<br><br>Tableau et donn\u00e9es interactifs: <br>[{SE_COUNT}?  ?&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href='SecchiDepth_Report.htm?id={ID}'>Disque Secchi</a><br>][{PH_COUNT}?  ?&nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href='TotalPhosphorus_Report.htm?id={ID}'>Concentration de phosphore total</a><br>]<br>Latitude <b>{globalConfig.deciToDegree(LATITUDE)}</b> Longitude <b>{globalConfig.deciToDegree(LONGITUDE)}</b><br><a href='mailto:lakepartner@ontario.ca?subject=Erreur de Portail ({globalConfig.wordCapitalize(LAKENAME)}, STN {STN}, N&deg; du lieu {SITEID})'>Signaler une erreur pour ce lieu</a>.<br>";
