...
globalConfig.tableFieldList = [
	...
	{name: globalConfig.fieldNamesList[5], value: "[{SE_COUNT}?N/A?<a href='" + globalConfig.SecchiDepth_ReportName + "?id={ID}'>" + globalConfig.chooseLang("Report", "Signaler") + "</a>]"},
	{name: globalConfig.fieldNamesList[6], value: "[{PH_COUNT}?N/A?<a href='" + globalConfig.TotalPhosphorus_ReportName + "?id={ID}'>" + globalConfig.chooseLang("Report", "Signaler") + "</a>]"},		
