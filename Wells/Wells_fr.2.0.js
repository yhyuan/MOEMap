			...
			<tr>\
				<td colspan="2">\
					<div id="information" style="margin-top:10px;">\
						Par exemple: <strong>Adresse</strong>, <strong>No de la plaque d’identification du puits</strong>, <strong>numéro d’identification du puits</strong> ou consulter l’aide pour de l’information sur les recherches avancées.\
															</div>\
				</td>\
			</tr>\
		</table>';*/
globalConfig.searchControlHTML = '<label class="element-invisible" for="map_query">Recherche carte</label>\
	...
	<input type="submit" onclick="globalConfig.search()" id="search_submit" value="Recherche" title="Recherche" />\
	<br/>\
	<input id="currentMapExtent" type="checkbox" name="currentExtent" title="&Eacute;tendue de la carte courante">\
	<label for="currentExtent" class=\'option\'>&Eacute;tendue de la carte courante</label><div id="information"></div>';