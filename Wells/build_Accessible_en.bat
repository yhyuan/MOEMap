...
REM cp Wells_Accessible_en.2.0-min.js /Z/Public/Wells/en
rm Wells_Accessible_en.2.0-min.js
cp Wells_Accessible_en.htm /Y/web/Wells/en
REM cp Wells_Accessible_en.htm /Z/Public/Wells/en
mv /Y/web/Wells/en/Wells_Accessible_en.htm  /Y/web/Wells/en/Wells_Accessible.htm
REM mv /Z/Public/Wells/en/Wells_Accessible_en.htm  /Z/Public/Wells/en/Wells_Accessible.htm
