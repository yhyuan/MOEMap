...
REM cp Wells_Accessible_fr.2.0-min.js /Z/Public/Wells/fr
rm Wells_Accessible_fr.2.0-min.js
cp Wells_Accessible_fr.htm /Y/web/Wells/fr
REM cp Wells_Accessible_fr.htm /Z/Public/Wells/fr
mv /Y/web/Wells/fr/Wells_Accessible_fr.htm  /Y/web/Wells/fr/Wells_Accessible.htm
REM mv /Z/Public/Wells/fr/Wells_Accessible_fr.htm  /Z/Public/Wells/fr/Wells_Accessible.htm
