...
cp Wells_Report_en.2.0-min.js /Z/Public/Wells/en
rm Wells_Report_en.2.0-min.js
cp Wells_Report_en.htm /Y/web/Wells/en
cp Wells_Report_en.htm /Z/Public/Wells/en
mv /Y/web/Wells/en/Wells_Report_en.htm  /Y/web/Wells/en/Wells_Report.htm
mv /Z/Public/Wells/en/Wells_Report_en.htm  /Z/Public/Wells/en/Wells_Report.htm
