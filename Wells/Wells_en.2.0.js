...
//globalConfig.searchHelpTxt = "You may search by <strong>Well Tag #</strong>, <strong>Well ID</strong>, <strong>Address</strong>";
...
/*globalConfig.searchControlHTML = '<label class="element-invisible" for="map_query">Search the map</label>\
	...
	<label for="currentExtent" class=\'option\'>Search current map display only</label><div id="information"></div>';
*/