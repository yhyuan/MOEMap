...
globalConfig.otherInfoHTML = '<p><img src="http://www.ene.gov.on.ca/stdprodconsume/groups/lr/@ene/documents/images/stdprod_100989.jpg" alt="PGMN legend french" /></p><p>Certaines donn&eacute;es scientifiques et de surveillance n&rsquo;existent qu&rsquo;en anglais.</p>';

globalConfig.WellLang = "Puits";
globalConfig.tabsTemplateContentWell = "Num\u00e9ro du puits du r\u00e9seau: <b>{PGMN_WELL}</b><br>Office de protection de la nature: <b>{CONS_AUTHO}</b><br>Comt\u00e9: <b>{globalConfig.wordCapitalize(COUNTY)}</b><br>Canton: <b>{globalConfig.wordCapitalize(TOWNSHIP)}</b>, <b>{CONCESSION}</b>, <b>{LOT}</b><br>Num\u00e9ro du site: <b>{SiteID}</b><br>Latitude <b>{globalConfig.deciToDegree(LATITUDE)}</b>&nbsp;&nbsp;&nbsp;Longitude <b>{globalConfig.deciToDegree(LONGITUDE)}</b><br><BR>Altitude (m.a.s.l.):<b>{ELVA_GROUN}</b> m\u00e8tres<br>Profondeur du puits (m\u00e8tres sous le sol): <b>{WELL_DEPTH}</b><br>Type d'aquif\u00e8re: <b>{AQUIFER_TY}</b><br>Lithologie de l'aquif\u00e8re: <b>{AQUIFER_LI}</b><br>Num\u00e9ro du registre de puits d'eau (NRPE): <b>{STRATIGRAP}</b><br>Description stratigraphique des rapports ou notes: <b>{STRATI_DES}</b><br>NRPE des puits situ\u00e9s pr\u00e8s d'un puits du r\u00e9seau: <b>{NO_RECORD}</b><br>Diam\u00e8tre du puits ou pi\u00e9zom\u00e8tre: <b>{WEL_PIEZOM}</b> cm<br>Intervalle d'\u00e9cran ou intervalle \u00e0 trou ouvert (m\u00e8tres sous terre): <b>{SCREEN_HOL}</b>";
